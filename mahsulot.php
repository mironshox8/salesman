...
$database = "products_db"; // Bazaning nomi
...
// SQL so‘rovi
$sql = "SELECT mahsulot_nomi, unical_id FROM mahsulotlar";
$result = $conn->query($sql);
?>
...
<body>
    <h2 style="text-align: center;"><b>Mahsulotlar ro'yxati</b></h2>
    <div class="container">
        <?php
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                $image_path = "images/" . strtolower(str_replace(' ', '_', $mahsulot_nomi)) . ".jpg";
                ...
                echo "<img src='$image_path' alt='$mahsulot_nomi' width='150' height='120'>";
                echo "<h2><strong>  $bosh </strong></h2>";
                echo "<h3>ID: $unical_id</h3>";
                echo "</div>";
            }
        } else {
